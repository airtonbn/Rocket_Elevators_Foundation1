Trestle.admin(:Elevator_by_client) do
    ...
    controller do
      def index
        ...
        conn = PG::Connection.open(host: "codeboxx-postgresql.cq6zrczewpu2.us-east-1.rds.amazonaws.com", port: 5434, dbname: "samuel_asselin", user: "codeboxx", password: "Codeboxx1!")
