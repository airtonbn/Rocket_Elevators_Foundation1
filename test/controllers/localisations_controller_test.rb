...
class LocalisationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create localisation" do
    assert_difference('Localisation.count') do
      post localisations_url, params: { localisation: { : @localisation., integer: @localisation.integer, string: @localisation.string } }
    end
  ...
  test "should update localisation" do
    patch localisation_url(@localisation), params: { localisation: { : @localisation., integer: @localisation.integer, string: @localisation.string } }
